...
try:
    results = open('D:\Python\results.txt','w')
    results.write('hello')
except:
...
#//////////////////////////////////////////////////////////////////////////////////////////////////
print '# Autor: Carlos Ichiro Tellez Urakami'
print '# Purpose: Gateways automatization'
print '# Date:'
print '#/////////////////////////////////////'
print 'from PlatformFiles import *'
print 'from _UserFunctions import *'
print 'from openpyxl import *'
print 'import time'

print 'def Gateways(testcase):'
print '    testcase.safety_requirement = ,'  #Necesitas ver como poner un caracter '' dentro
print '    testcase.traceability = ,'             
print '    can_instance = CANoe()'
print '    try:'
print '        can_instance.Start()'
print '    except:'
print '        print("La simulacion ya esta corriendo")'
